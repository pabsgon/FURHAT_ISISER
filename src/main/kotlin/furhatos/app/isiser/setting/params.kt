...
const val LANGUAGE = "EN" // [EN|SV] EN default
...
const val SOURCEDATA_RANGE = "RAWDATA_FOR_LOADING_ENG!A3:AS300"  //The tab where the data lies.
...
const val NUM_GESTURES_PER_UTTERANCE = 2
